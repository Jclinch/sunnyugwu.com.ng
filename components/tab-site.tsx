...
//   const navRef = useNavRef<HTMLDivElement>(null)
...
//         <Image src="/images/sunnyUgwu.png" alt="" width={400} height={400} />
//       </div>
//       <div className="flex flex-col w-screen md:w-[600px] md:mt-[50px] px-8 md:px-0 text-sm md:text-4xl">
...
//           I&apos;m a developer who is well-versed in both front and back end
//           technologies. Having skills in HTML, CSS, JS, React/Next.js, Go,
//           Node.js and PostgreSQL. I develop, maintaining and integrating Restful
//           APIs for Web applications and also having experience in managing
//           databases and having exceptional problem-solving skills with a spirit
//           of collegiality and growth within the profession.
//         </p>
