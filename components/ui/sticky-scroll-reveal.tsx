...
//       }}
//       className="h-[42rem] overflow-y-auto flex justify-center relative space-x-[25.5rem] rounded-md p-5"//space-x- for the width of the bg
//       ref={ref}
//     >
...
//                   opacity: activeCard === index ? 1 : 0.3,
//                 }}
//                 className="text-kg text-slate-300 max-w-sm mt-10" //description
//               >
//                 {item.description}
//               </motion.p>
//             </div>
...
//         className={cn(
//           //for image size
//           "hidden lg:block h-[20rem] ml-[-200px] mt-[160px] rounded-md bg-white sticky top-10 overflow-hidden",
//           contentClassName
//         )}
//       >
  ...
  return (
    ...
    >
      <div className="div relative flex items-start justify-center px-4">
        ...
        <div className="max-w-xl">
      <div className="ml-[550px] mt-[25px] text-5xl text-[orangered]">Portfolio</div>
          {content.map((item, index) => (
            <div key={item.title + index} className="my-[80px] ml-[150px] w-full ">
              <motion.h2
                initial={{ opacity: 0 }}
